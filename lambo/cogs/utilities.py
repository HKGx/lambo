...
import discord
from discord.ext.commands import (Cog, Context, FlagConverter, Greedy, command,
                                  flag)
from discord.utils import escape_markdown

from lambo.main import CustomClient
from lambo.utils import FuzzyRoleConverter, codized, quoted, unwrap_channels
from lambo.utils.pagination import Paginator, PaginatorView
...
class UtilitiesCog(Cog, name="Utilities"):
    ...
    async def inrole(
        ...
        if flags.page not in range(1, len(members_pages) + 1):
            ...
            return
        print("5")
        paginator = Paginator(values=members_pages, current_page=flags.page)
        print("6")
